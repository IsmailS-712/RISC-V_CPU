...
VL_INLINE_OPT void Vdata_mem___024root___sequent__TOP__0(Vdata_mem___024root* vlSelf) {
    ...
    // Init
    IData/*16:0*/ __Vdlyvdim0__data_mem__DOT__data_array__v0;
    ...
    if ((1U & (~ (IData)(vlSelf->WE)))) {
        vlSelf->RD = vlSelf->data_mem__DOT__data_array
            [(0x1ffffU & (vlSelf->A >> 2U))];
    }
    if (vlSelf->WE) {
        __Vdlyvval__data_mem__DOT__data_array__v0 = vlSelf->WD;
