...
VL_ATTR_COLD void Vdata_mem___024root__trace_init_sub__TOP__0(Vdata_mem___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+11,"RD", false,-1, 31,0);
    for (int i = 0; i < 6; ++i) {
        tracep->declBus(c+1+i*1,"data_array", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vdata_mem___024root__trace_full_sub_0(Vdata_mem___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullIData(oldp+1,(vlSelf->data_mem__DOT__data_array[0]),32);
    bufp->fullIData(oldp+2,(vlSelf->data_mem__DOT__data_array[1]),32);
    bufp->fullIData(oldp+3,(vlSelf->data_mem__DOT__data_array[2]),32);
    bufp->fullIData(oldp+4,(vlSelf->data_mem__DOT__data_array[3]),32);
    bufp->fullIData(oldp+5,(vlSelf->data_mem__DOT__data_array[4]),32);
    bufp->fullIData(oldp+6,(vlSelf->data_mem__DOT__data_array[5]),32);
    bufp->fullBit(oldp+7,(vlSelf->clk));
    bufp->fullBit(oldp+8,(vlSelf->WE));
    bufp->fullIData(oldp+9,(vlSelf->A),32);
    bufp->fullIData(oldp+10,(vlSelf->WD),32);
    bufp->fullIData(oldp+11,(vlSelf->RD),32);
}
