...
VL_ATTR_COLD void Vtop___024root___settle__TOP__0(Vtop___024root* vlSelf) {
    ...
    if ((3U == (0x7fU & vlSelf->top__DOT__instr))) {
        ...
        if ((0x23U == (0x7fU & vlSelf->top__DOT__instr))) {
            ...
            vlSelf->top__DOT__control__DOT__ALUop = 
                ((IData)((0x63U == (0x707fU & vlSelf->top__DOT__instr)))
                  ? 1U : ((IData)((0x1063U == (0x707fU 
                                               & vlSelf->top__DOT__instr)))
                           ? 1U : ((0x6fU == (0x7fU 
                                              & vlSelf->top__DOT__instr))
                                    ? 3U : ((0x67U 
    ...
    if ((IData)(((0U == (IData)(vlSelf->top__DOT__control__DOT__ALUop)) 
                 & (0U == (0x7000U & vlSelf->top__DOT__instr))))) {
        vlSelf->top__DOT__ALUctrl = 5U;
    } else if (((0U == (IData)(vlSelf->top__DOT__control__DOT__ALUop)) 
